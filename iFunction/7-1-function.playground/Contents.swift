...
func youSaySomething(what: String) {
    print("Hi \(what)")
}

youSaySomething(what: "MotherFker")
...
func minusFunction(a: Int, b:Int) -> Int {
    let c = a - b
    return c
}

print(minusFunction(a: 5, b: 2))
